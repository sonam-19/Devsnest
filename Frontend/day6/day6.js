...
var is_array = function(input) {
  ...
  console.log("2.Write a JavaSript function to clone an array.");
  var array_Clone = function(arra1) {
   ...
   console.log("3.Write a JavaScript function to get the first element of an array.Passing a parameter'n'elements of the array");
